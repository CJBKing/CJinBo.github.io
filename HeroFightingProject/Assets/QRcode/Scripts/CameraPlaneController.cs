...
public class CameraPlaneController : MonoBehaviour {
	...
	void Awake () {
		...
		this.transform.localPosition = new Vector3(0,0,440f);

		#if UNITY_EDITOR
		transform.localEulerAngles = new Vector3(90,180,0);
		transform.localScale = new Vector3(width*100, 1.0f, height*100);
		...
		if (Screen.orientation == ScreenOrientation.Portrait||
			...
			transform.localScale = new Vector3(height/0.1f, 1.0f, width/0.1f);
			#elif UNITY_IOS
